...
export class SimulationsComponent {
    ...
    },
    {
      ...
      color: '#9C27B0',
      simulations: [
        { title: 'Атом водорода', description: 'Изучите распределение электронов в атоме', points: ['Энергетические уровни', 'Волновая функция', 'Состояния'], link: '/simulation/quantum/hydrogen' },
    ...
    },
    {
      ...
      color: '#F44336',
      simulations: [
        { title: 'Радиоактивный распад', description: 'Понимайте процесс распада и полураспад', points: ['Типы распада', 'Скорость распада', 'Применения'], link: '/simulation/nuclear/decay' },
        { title: 'Ядерные реакции', description: 'Изучите реакции между ядрами', points: ['Слияние', 'Деление', 'Энергия'], link: '/simulation/nuclear/reactions' },
